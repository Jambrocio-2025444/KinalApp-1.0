...
Stack Tecnológico: Utiliza las versiones más recientes y estables del mercado. Java 21 ofrece las últimas mejoras de rendimiento, mientras que Spring Boot 4 facilita la configuración automática, el despliegue rápido y se implemento Spring Security.
...
Seguridad/Control: Gestión de usuarios y estados de actividad ("activos"), autenticación con Spring Security, roles (ADMIN/USUARIO) y página de acceso denegado.
...
Config → Maneja los roles y permisos de la aplicación web
